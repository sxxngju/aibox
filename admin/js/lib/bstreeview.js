...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "bstreeview",
        defaults = {
            expandIcon: 'bi bi-plus-circle-fill',
            collapseIcon: 'bi bi-dash-circle-fill',
            indent: 1.25
        };
    /**
    ...
    var templates = {
        ...
        treeviewGroupItem: '<div class="list-group collapse show" id="itemid"></div>',
